...
const Overlay = (props) => {
  ...
  if (!state[props.state]) {
    return null // Tidak menampilkan apa-apa jika state tidak dikenali
  }
  return (
    <motion.div
...
const Backdrop = (props) => {
  return <div onClick={props.onHide} className='fixed inset-0 z-20 bg-black cursor-pointer opacity-80'></div>
}
